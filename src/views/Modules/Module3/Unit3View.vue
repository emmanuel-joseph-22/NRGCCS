<!-- <script src="../../../scripts/modules/Module3/unit3.js"></script> -->
<template>
    <!-- table of contents -->
    <section id="contents" class="flex flex-col w-full px-4 items-center">
        <h1 class="text text-gray-400">UNIT 3</h1>
        <h1 class="text-xl text-gray-700">The PRO-fessional</h1>

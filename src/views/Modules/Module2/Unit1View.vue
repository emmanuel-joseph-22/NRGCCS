<!-- <script src="../../../scripts/modules/Module2/unit1.js"></script> -->
<template>
  <!-- table of contents -->
  <section id="contents" class="flex flex-col w-full px-4 items-center">
      <h1 class="text text-gray-400">UNIT 1</h1>
      <h1 class="text-xl text-gray-700">Conversing with Purpose</h1>
...
export default {
  ...
  data() {
    return {
      lessons: [
        {
          title: "Introducing Strangers to Each Other",
          link: "/module2/unit1/lesson1",
          contents: [
        ...
        {
          title: "Expressing Request",
          link: "/module2/unit1/lesson3",
          contents: [
            "Lorem ipsum dolor sit amet",
            "Lorem ipsum dolor sit amet",
            "Lorem ipsum dolor sit amet"

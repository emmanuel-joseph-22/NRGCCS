<!-- <script src="../../../scripts/modules/Module2/unit3.js"></script> -->
<template>
  <!-- table of contents -->
  <section id="contents" class="flex flex-col w-full px-4 items-center">
      <h1 class="text text-gray-400">UNIT 3</h1>
      <h1 class="text-xl text-gray-700">Leisure and Recreation</h1>
...
export default {
  ...
  data() {
    return {
      lessons: [
        {
          title: "A Walk That's Always Worthwhile",
          link: "/module2/unit3/lesson1",
          contents: [
            "Let’s take a walk: Reading", 
            "Listening", 
            "Grammar Points",
        ...
        {
          title: "Scenematic Ventures",
          link: "/module2/unit3/lesson2",
          contents: [
            "The Big Screen: Reading", 
            "Listening", 
            "Classroom Activity: Essay Writing"
          ]
        },
        {
          title: "More Than Just Staying Fit",
          link: "/module2/unit3/lesson3",
          contents: [
            "Which exercise is for me?: Reading", 
            "Listening",
            "Grammar Points", 
            "Pronunciation", 
            "Classroom Activity: Essay Writing"
        ...
        {
          title: "Exploring Beaches",
          link: "/module2/unit3/lesson4",
          contents: [
            "Spending Some Time by the sea: Reading", 
            "Listening", 
            "Grammar Points", 
            "Pronunciation", 
            "Classroom Activity"
        ...
        {
          title: "Chasing Heights",
          link: "/module2/unit3/lesson5",
          contents: [
            "Got to Reach the top: Reading", 
            "Listening",
            "Grammar Points", 
            "Pronunciation", 
            "Classroom Activity: Paragraph Writing"
          ]
        }
      ],
      isModalOpen: false,

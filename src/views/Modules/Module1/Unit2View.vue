<!-- <script src="../../../scripts/modules/Module1/unit2.js"></script> -->
<template>
  <!-- table of contents -->
  <section id="contents" class="flex flex-col w-full px-4 items-center">
      <h1 class="text text-gray-400">UNIT 2</h1>
      <h1 class="text-xl text-gray-700">Academic Presentation</h1>
...
export default {
  ...
  data() {
    return {
      lessons: [
        {
          title: "Managing Information for Audience",
          link: "/module1/unit2/lesson1",
          contents: [
        ...
        {
          title: "Composing Visuals",
          link: "/module1/unit2/lesson2",
          contents: [
            "Lorem ipsum dolor sit amet", 
            "Lorem ipsum dolor sit amet", 
            "Lorem ipsum dolor sit amet"
        ...
        {
          title: "Disseminating Research Findings",
          link: "/module1/unit2/lesson4",
          contents: [
            "Lorem ipsum dolor sit amet", 
            "Lorem ipsum dolor sit amet", 
            "Lorem ipsum dolor sit amet"
        ...
        {
          title: "Pitching Innovative Solutions",
          link: "/module1/unit2/lesson5",
          contents: [
            "Lorem ipsum dolor sit amet", 
            "Lorem ipsum dolor sit amet", 
            "Lorem ipsum dolor sit amet"

<template>
    <section class="flex flex-col w-full px-2 gap-4">
        ...
        <div>
            <div>
                ...
                <p>TThis module focuses on the components of teaming and collaboration amongst students. This also tackles the used of modals, must and have to in different sentence and conversation.</p>
            </div>
            <div>
                <h6>Language Functions</h6>
                <p>Accompany, team, pen friend, perform, persuade Grammar Points: Modals: must/have to</p>
            </div>
        </div>
    </section>
    <!-- objectives -->
    <section class="w/10/12">
        Accompany, team, pen friend, perform, persuade Grammar Points: Modals: must/have to
        <ol>
            <li>Collaborate with other students.</li>
            <li>Demonstrate positive feelings, emotions and attitudes towards another.</li>
            <li>Take the initiative to interact with others</li>
            <li>Use modals in conversation.</li>    
        </ol>
    </section>

    <!-- part 1 -->
    <section class="w-11/12">
        <h1 class="ml-12">Pre Task A: Spot the Difference</h1>
        <h6 class="ml-12"></h6>
    ...
    <section class="w-11/12">
        ...
        <h6 class="ml-12">Read carefully the student conversation below be ready to answer the questions below.</h6>
        <p class="">
            ...
            James: Don’t worry, I have notes and some previous papers, you prepare them and for practical watch science subject tutorials on the YouTube channel “T4Tutorials” it will give you guidance.
            Robert: Thank you! I follow your advice and prepare hard before the exams, why don’t we plan together to study together for a few days, it will m otivate me and help me to overcome my weaknesses. I will try.
            James: Of course! I will make time for you tomorrow and come in the evening and we will memorize the subjects together.

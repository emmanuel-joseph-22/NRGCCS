<template>
  ...
  <section id="contents" class="flex flex-col w-full px-4 items-center">
    ...
    <h1 class="text-xl text-gray-700">Daily Life in School</h1>
...
export default {
  ...
  data() {
    return {
      lessons: [
        {
          title: "Familiarizing with Learning Tasks",
          link: "/module1/unit1/lesson1",
          contents: [
            "Vocabulary Builder", 
            "Reading Authentic Text", 
            "Reading Comprehensions Questions", 
            "Viewing Authentic Text", 
            "Reading Comprehensions Questions", 
            "Grammar Points", 
        ...
        {
          title: "Accessing Resources at the Library",
          link: "/module1/unit1/lesson2",
          contents: [
            "Pre-Task. Webpage analysis", 
            "Vocabulary Builder", 
        ...
        {
          title: "Collaborating with other Students",
          link: "/module1/unit1/lesson3",
          contents: [
            "Pre Task A. Spot the Difference (Teaming)", 
            "Working with Other Students"
          ],
        },
        {
          title: "Consulting Class Facilitators & Advisers",
          link: "/module1/unit1/lesson4",
          contents: [
            "Pre-Task. Picture analysis.", 
            "Vocabulary Builder", 
            "Reading Comprehension", 
            "Viewing"
          ],
        ...
        {
          title: "Working at the Laboratory",
          link: "/module1/unit1/lesson5",
          contents: [
            "Pre-Task. Picture analysis.", 

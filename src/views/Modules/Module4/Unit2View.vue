<!-- <script src="../../../scripts/modules/module4/unit2.js"></script> -->
<!-- <h1 class="text text-gray-400">UNIT 2</h1>
<h1 class="text-xl text-gray-700">Ethics must be Global</h1> -->
<template>
    <!-- table of contents -->
  ...
  export default {
    ...
    data() {
      return {
        lessons: [
          {
            title: "What's Your P. O. V",
            link: "/module4/unit2/lesson1",
            contents: [
          ...
          {
            title: "Leaving Good Impressions",
            link: "/module4/unit2/lesson5",
            contents: [
              "Lorem ipsum dolor sit amet", 
              "Lorem ipsum dolor sit amet", 
              "Lorem ipsum dolor sit amet"

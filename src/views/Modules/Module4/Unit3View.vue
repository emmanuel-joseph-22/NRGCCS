...
<h1 class="text-xl text-gray-700">The World in "an APPLE"</h1> -->
<template>
    <!-- table of contents -->
    ...
    data() {
      return {
        lessons: [
          ...
          {
            title: "E-ntertainment",
            link: "/module4/unit3/lesson4",
            contents: [
              "Lorem ipsum dolor sit amet", 
              "Lorem ipsum dolor sit amet", 
              "Lorem ipsum dolor sit amet"

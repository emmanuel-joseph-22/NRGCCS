<!-- <script src="../../../scripts/modules/module4/unit1.js"></script> -->
<template>
    <!-- table of contents -->
    <section id="contents" class="flex flex-col w-full px-4 items-center">
        <h1 class="text text-gray-400">UNIT 1</h1>
        <h1 class="text-xl text-gray-700">Meeting the World</h1>
  ...
  data() {
    return {
      lessons: [
        ...
        {
          title: "Arts and Culture Do Speak",
          link: "/module4/unit1/lesson2",
          contents: [
            "Lorem ipsum dolor sit amet", 
            "Lorem ipsum dolor sit amet", 
            "Lorem ipsum dolor sit amet"
        ...
        {
          title: "The World in Diversed Perspective",
          link: "/module4/unit1/lesson3",
          contents: [
            "Lorem ipsum dolor sit amet", 
            "Lorem ipsum dolor sit amet", 
            "Lorem ipsum dolor sit amet"
        ...
        {
          title: "Travel and Meet People",
          link: "/module4/unit1/lesson4",
          contents: [
            "Lorem ipsum dolor sit amet", 
            "Lorem ipsum dolor sit amet", 
            "Lorem ipsum dolor sit amet"
        ...
        {
          title: "Profiling the other Party",
          link: "/module4/unit1/lesson5",
          contents: [
            "Lorem ipsum dolor sit amet", 
            "Lorem ipsum dolor sit amet", 
            "Lorem ipsum dolor sit amet"

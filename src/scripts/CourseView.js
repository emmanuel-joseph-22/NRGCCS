...
export default {
    ...
    methods: {
        ...
        showSubComponent(submoduleName) {
            ...
            let targetSubmodule = this.modules
                .flatMap(module => module.submodules)
                .find(submodule => submodule.name === submoduleName);
            ...
            if(targetSubmodule){
                ...
                targetSubmodule.active = !targetSubmodule.active;

                this.currentSubComponent = targetSubmodule.component;
                this.submoduleRoute = targetSubmodule.route;
                this.$router.push({ path: this.submoduleRoute });
            }
        },
        goToLesson(LessonIndex, ModIndex, SubIndex) {
            this.modules[ModIndex].submodules[SubIndex].lessons.forEach((lesson) => {
                lesson.active = false;
            });
            let targetLesson = this.modules[ModIndex].submodules[SubIndex].lessons[LessonIndex];
            targetLesson.active = !targetLesson.active
            this.$router.push({ path: targetLesson.route });
